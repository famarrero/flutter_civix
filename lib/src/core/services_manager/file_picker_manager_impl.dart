...
class FilePickerManagerImpl implements FilePickerManager {
  ...
  Future<Either<String, File>> getSingleFile() async {
    try {
      ...
      if (result != null) {
        ...
        return left(S.current.noFileSelected);
      }
    } catch (e) {
  ...
  @override
  Future<Either<String, List<File>>> getMultiplesFilesByExtensions(List<String> extensions) async {
    try {
  ...
  @override
  Future<Either<String, File>> getSingleFileByExtensions(List<String> extensions) async {
    try {
